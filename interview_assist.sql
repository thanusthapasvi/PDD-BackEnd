...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2026 at 05:03 PM
...
(5, 'Wipro', '[\"Elite\",\"Turbo\",\"Velocity\"]', '[\"SDE\",\"Project Engineer\"]', '[\"Bangalore\",\"Hyderabad\",\"Pune\",\"Chennai\",\"Noida\",\"Kolkata\"]', '[\r\n    {\"round\":\"Aptitude Test\",\"questions\":\"30 MCQs\",\"duration\":90},\r\n    {\"round\":\"Coding Test\",\"questions\":\"2 Coding\",\"duration\":60}\r\n  ]', '{\r\n    \"about\":\"Wipro is a multinational IT services and consulting company.\",\r\n    \"min_package\":3.5,\r\n    \"max_package\":6.5,\r\n    \"website\":\"https://www.wipro.com\",\r\n    \"ceo\":\"Srinivas Pallia\",\r\n    \"important\":\"Wipro NLTH is the main fresher hiring exam.\"\r\n  }'),
...
(1, 'What is the difference between Abstract Class and Interface in Java?', 'Abstract class can have abstract and non-abstract methods...', NULL, NULL, NULL, NULL),
(2, 'What is normalization in DBMS?', 'Normalization is the process of organizing data...', NULL, NULL, NULL, NULL),
(3, 'What is the difference between GET and POST?', 'GET sends data in URL...', NULL, NULL, NULL, NULL),
(4, 'Write a program to reverse a string in Java.', 'public class ReverseString {...}', NULL, NULL, NULL, NULL),
(5, 'What is OOPS?', 'OOPS stands for Object Oriented Programming System...', NULL, NULL, NULL, NULL),
(6, 'What is REST API?', 'REST is an architectural style...', NULL, NULL, NULL, NULL),
(7, 'Difference between Array and ArrayList?', 'Array has fixed size...', NULL, NULL, NULL, NULL),
...
CREATE TABLE `users` (
  ...
  `role` enum('fresher','alumni','placement_admin') NOT NULL DEFAULT 'fresher',
...
(1, 'Thanus Thapasvi Thummala', 't4872188@gmail.com', '$2y$10$/.IwfDSjkEsPgT6B2.NGGuYRSYbBPHmWcG/d6DaiKa8.VNtcJc0ey', 'alumni', 4, 8, 0, '$2y$10$zRdXNLvBUSKaJDRFcVGd3OJq3QUsUGu8SoXleWJQpS0lwuiSx/E5e', '2026-02-08 09:32:00', '2026-01-28 09:17:44'),
...
(5, 'Atul', 'atulbhakra@gmail.com', '$2y$10$XAjHgOqqZ8m8LLVyIXI9LOJFsEf8B0HeP.H79iEmkuB3HjxUxyP8m', 'alumni', 4, 2, 1, NULL, NULL, '2026-02-18 16:49:44');
